...
agent. It is the deepOrin analog of Claude Code's CLAUDE.md.
...
- Hierarchical docs: `DEEPORIN.md` (this file, committed/shared), `DEEPORIN.local.md`
  (personal, git-ignored), user-global `~/.config/deeporin/DEEPORIN.md`, and any
  `DEEPORIN.md` in an ancestor dir. `AGENTS.md` is accepted as a fallback name.
