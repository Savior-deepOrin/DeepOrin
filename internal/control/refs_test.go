...
func TestClassifyRef(t *testing.T) {
	...
	files := map[string]bool{
		"src/main.go": true,
		"README.md":   true,
		".deeporin/attachments/clipboard-20260601-010203.000000.png": true,
		".deeporin/attachments/clipboard-20260601-010203.000000.yml": true,
		".deeporin/attachments/clipboard-20260601-010203.000000.zip": true,
	}
	...
	cases := []struct {
		...
		{".deeporin/attachments/clipboard-20260601-010203.000000.png", true, refImage},
		{".deeporin/attachments/clipboard-20260601-010203.000000.yml", true, refFile},
		{".deeporin/attachments/clipboard-20260601-010203.000000.zip", true, refFile},
...
func TestResolveRefsAttachmentKinds(t *testing.T) {
	temp := t.TempDir()
	attachmentsDir := filepath.Join(temp, ".deeporin", "attachments")
	if err := os.MkdirAll(attachmentsDir, 0o755); err != nil {
		t.Fatal(err)
	}
	ymlRef := filepath.ToSlash(".deeporin/attachments/config.yml")
	zipRef := filepath.ToSlash(".deeporin/attachments/archive.zip")
	pngRef := filepath.ToSlash(".deeporin/attachments/shot.png")
	...
	if !strings.Contains(block, `<file path="`+ymlRef+`">`) || !strings.Contains(block, "name: deeporin") {
