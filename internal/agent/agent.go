...
// SetGate installs the per-call permission gate. Used by `deeporin chat` to swap the
...
// `deeporin chat --resume` to load a saved JSONL transcript before the first turn,
