...
// $LC_ALL / $DEEPORIN_LANG. Unknown locales return "" so DetectLanguage falls
...
// TestDetectLanguagePriority verifies override beats env and that DEEPORIN_LANG
...
func TestDetectLanguagePriority(t *testing.T) {
	...
	t.Setenv("DEEPORIN_LANG", "en")
	if got := DetectLanguage(""); got != "en" {
		t.Errorf("DEEPORIN_LANG=en overriding LANG=zh: got %q, want en", got)
	}
