...
// than shipped in the deeporin binary, which keeps installs small. Resolve finds
...
// BundleDirName is the optional directory, beside the deeporin.executable, where
...
// bundled looks for the CodeGraph launcher unpacked beside the deeporin binary.
