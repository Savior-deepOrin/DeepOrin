// Package netclient builds HTTP clients and proxy resolvers that share deepOrin's
...
// NewHTTPClient returns an HTTP client with deepOrin proxy settings applied.
