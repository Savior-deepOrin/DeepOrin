...
func TestProviderConfigured(t *testing.T) {
	...
	cases := []struct {
		...
		{"key set", ProviderEntry{APIKeyEnv: "DEEPORIN_TEST_KEY"}, true},
		{"key env empty", ProviderEntry{APIKeyEnv: "DEEPORIN_TEST_EMPTY"}, false},
		{"key env unset", ProviderEntry{APIKeyEnv: "DEEPORIN_TEST_MISSING"}, false},
