# Contributing to deepOrin

Thank you for your interest in contributing to deepOrin! This guide covers
...
```bash
git clone https://github.com/Savior-deepOrin/deeporin.git
cd DeepSeek-Reasonix
go build ./cmd/deeporin    # builds the CLI binary
...
| `internal/memory` | DEEPORIN.md hierarchy + auto-memory |
