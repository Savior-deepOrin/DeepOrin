...
func (a *App) startTray() {
	...
	t.end = startDesktopTray(func() {
		...
		systray.SetTitle("deepOrin")
		systray.SetTooltip("deepOrin")
...
func trayMenuLabels(locale string) trayLabels {
	if locale == "zh" {
		return trayLabels{
			openTitle:   "打开",
			openTooltip: "打开 deepOrin 窗口",
			quitTitle:   "退出",
			quitTooltip: "退出 deepOrin",
		}
	}
	return trayLabels{
		openTitle:   "Open",
		openTooltip: "Open the deepOrin window",
		quitTitle:   "Quit",
		quitTooltip: "Quit deepOrin",
	}
}
