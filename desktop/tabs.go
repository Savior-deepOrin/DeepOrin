...
// workspace root is the deeporin user config directory.
...
func desktopConfigDir() string {
	...
	if err != nil {
		...
		return filepath.Join(home, ".deeporin")
	}
...
func topicTitlesPath(workspaceRoot string) string {
	...
	return filepath.Join(workspaceRoot, ".deeporin", topicTitlesFile)
}
...
func topicTitleSourcesPath(workspaceRoot string) string {
	...
	return filepath.Join(workspaceRoot, ".deeporin", topicTitleSourcesFile)
}
...
func topicCreatedAtsPath(workspaceRoot string) string {
	...
	return filepath.Join(workspaceRoot, ".deeporin", topicCreatedAtsFile)
}
...
func globalWorkspaceRoot() string {
	...
	if err != nil {
		home, _ := os.UserHomeDir()
		return filepath.Join(home, ".deeporin", "global-workspace")
	}
	return filepath.Join(dir, "deeporin", "global-workspace")
}
