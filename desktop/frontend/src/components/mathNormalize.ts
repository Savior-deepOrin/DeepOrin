...
const DM = "__DEEPORIN_MATH_DISPLAY__";
const IM = "__DEEPORIN_MATH_INLINE__";
const LB = "__DEEPORIN_LATEX_LINEBREAK__";
const DOLLAR = "&#36;";
...
function unusedPlaceholderPrefix(s: string): string {
  let prefix = "__DEEPORIN_PROTECTED_CODE__";
  let n = 0;
  while (s.includes(prefix)) {
    n += 1;
    prefix = `__DEEPORIN_PROTECTED_CODE_${n}__`;
  }
  return prefix;
}
