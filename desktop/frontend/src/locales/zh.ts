...
export const zh: Record<DictKey, string> = {
  ...
  "sidebar.navigation": "deepOrin 导航",
  ...
  // 输入框
  "composer.placeholder": "给 deepOrin 发消息…  ( / 命令 · @ 文件 · ! 终端 )",
  ...
  "memory.noDocs": "未找到 DEEPORIN.md。可在上方快速添加一条。",
  ...
  "memory.emptySavedBody": "只保存对后续 deepOrin 会话有帮助的长期背景。",
  ...
  "settings.closeBehavior.quit": "退出 deepOrin",
  ...
  "settings.agentRuntimeHint": "作为全局默认；项目里的 ./deeporin.toml 可覆盖。0 表示不限。",
  ...
  "settings.botInstallSubtitle": "连接完成后即可在聊天里调用 deepOrin。",
  ...
  "settings.style.cyber.zh": "赛博",
  "settings.style.cyber.note": "冷酷",
  "settings.style.cyber.desc": "极致深黑配冷灰银,赛博朋克美学,高对比低饱和,长时间编码不刺眼。",
  ...
  "settings.pageDesc.memory": "管理 deepOrin 会长期参考的偏好、项目约定和指令文件。",
  ...
  "settings.addProvider.officialChoiceHint": "从 deepOrin 预设的 DeepSeek 与 Mimo 接入中选择。",
  ...
  "settings.hooksPathProjectHint": "项目 hooks 保存到当前工作区的 .deeporin/settings.json。",
  ...
  "settings.hooksGlobalHint": "保存为全局配置。新的 deepOrin 会话会在 /new 或重启后加载。",
  ...
  "updater.autoCheckHint": "关闭后，deepOrin 打开时不会自动检查更新；你仍可在此页手动检查。",
  ...
  "onboarding.visionLabel": "识图模型 API 密钥（可选）",
  "onboarding.visionPlaceholder": "sk-…  千问 / 小米 MiMo",
  "onboarding.visionHint": "支持千问 (Qwen) 或小米 MiMo 视觉模型，用于图片识别",
  ...
  // 崩溃兜底页
  "crash.title": "deepOrin 遇到错误 —— 可以一键发送报告，或复制后反馈",
  "crash.copy": "复制",
  "crash.send": "发送报告",
  "crash.sending": "发送中…",
  "crash.sent": "已发送，谢谢！",
  ...
  "mock.askQ2Header": "deepOrin 构建",
  "mock.askQ2Prompt": "对于 deeporin 二进制缺失的问题，你想怎么做？",
