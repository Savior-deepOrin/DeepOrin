...
export const en = {
  ...
  "sidebar.navigation": "deepOrin navigation",
  ...
  // composer
  "composer.placeholder": "Message deepOrin…  ( / commands · @ files · ! shell )",
  ...
  "memory.noDocs": "No DEEPORIN.md found. Quick-add one above.",
  ...
  "memory.emptySavedBody": "Save durable background only when it should help future deepOrin sessions in this project.",
  ...
  "settings.closeBehavior.quit": "Quit deepOrin",
  ...
  "settings.agentRuntimeHint": "Used as global defaults; ./deeporin.toml can override them per project. 0 means unlimited.",
  ...
  "settings.botInstallSubtitle": "Once connected, deepOrin can be used from chat.",
  ...
  "settings.style.cyber.zh": "Cyber",
  "settings.style.cyber.note": "Cold",
  "settings.style.cyber.desc": "Deep black with cool silver accents, cyberpunk aesthetic, high contrast low saturation.",
  ...
  "settings.pageDesc.memory": "Manage preferences, project conventions, and instruction files deepOrin keeps referencing.",
  ...
  "settings.addProvider.officialChoiceHint": "Choose from deepOrin presets for DeepSeek and Mimo.",
  ...
  "settings.hooksPathProjectHint": "Project hooks are saved to .deeporin/settings.json in the current workspace.",
  ...
  "settings.hooksGlobalHint": "Saved globally. New deepOrin sessions load it after /new or restart.",
  ...
  "updater.autoCheckHint": "When off, deepOrin won't check automatically when it opens. You can still check manually here.",
  ...
  "onboarding.title": "Connect deepOrin",
  ...
  "onboarding.visionLabel": "Vision Model API Key (optional)",
  "onboarding.visionPlaceholder": "sk-…  Qwen / Xiaomi MiMo",
  "onboarding.visionHint": "Supports Qwen or Xiaomi MiMo vision models for image recognition",
  ...
  // crash page
  "crash.title": "deepOrin hit an error — send us the report, or copy it",
  "crash.copy": "Copy",
  ...
  "mock.askQ2Header": "deepOrin build",
  "mock.askQ2Prompt": "What do you want to do about the missing deeporin binary?",
  ...
  "mock.changedFile2Path": ".deeporin/project.md",
};
