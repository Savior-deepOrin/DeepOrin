...
const STORAGE_KEY = "deeporin.layoutPreferences.v1";

const LEGACY_SIZE_KEYS: Record<LayoutSizeKey, string[]> = {
  sidebarWidth: ["deeporin.sidebar.width"],
  sidebarWidthGraphite: [],
  rightDockWidth: [],
  rightDockTreeWidth: [],
  rightDockPreviewWidth: [],
  workspaceFileTreePanelWidth: [],
  workspaceTreeWidth: ["deeporin.workspaceTree.width"],
  composerHeight: ["deeporin.composerHeight"],
  drawerWidth: ["deeporin.drawer.width"],
  settingsDrawerWidth: ["deeporin.settingsDrawer.width"],
};
