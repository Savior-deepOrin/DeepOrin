...
// credentialsPath is the deeporin-owned global secrets file the settings panel
// writes API keys to — the same file `deeporin setup` writes and config.loadDotEnv
