// Command deeporin-desktop is the Wails shell around the deepOrin kernel: a native
...
// a nested module (deeporin/desktop) so the CGO/WebKit desktop build never touches
...
import (
	...
	// cmd/deeporin does — boot.Build resolves providers/tools from these registries.
...
// mirroring cmd/deeporin/main.go. The auto-updater reads it (App.Version) to compare
...
const disableWebview2GPUEnv = "DEEPORIN_DESKTOP_DISABLE_WEBVIEW2_GPU"
