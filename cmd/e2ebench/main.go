...
func main() {
	flag.Usage = func() {
		fmt.Fprintf(flag.CommandLine.Output(), "e2ebench — deepOrin end-to-end benchmark.\n\n")
	...
	bin := flag.String("bin", "deeporin", "path to the deeporin binary")
...
func render(results []result) string {
	...
	fmt.Fprintf(&b, "## 🤖 deepOrin e2e benchmark\n\n")
